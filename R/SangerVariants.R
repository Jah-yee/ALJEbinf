...
#'
#' This function operates on output generated by the \code{callSangerVariants_fasta} function.
#' The output that \code{callSangerVariants_fasta} contains variants for each Sanger sequence,
...
#'
#' @param variants A list of called variant tables, as output by the \code{callSangerVariants_fasta} function.
